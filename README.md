...
2. Add the list of exempted email to the `exemptedUsers` list. 
2. Run the script to log actions without applying changes.
3. Verify the logs for expected classifications and actions.
...
- **Observation**: During testing, the script successfully ran for 10 or more minutes without interruptions.
